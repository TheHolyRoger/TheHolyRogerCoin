The Holy Roger Core version 0.14.2 is now available from:
...
The Holy Roger Core has supported automatically pruning the blockchain since 0.13.2. Pruning
...
When The Holy Roger Core is out-of-sync on startup, a semi-transparent information
...
The Alert System was disabled and deprecated in The Holy Roger Core 0.10.4 and removed in 0.13.2. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of The Holy Roger Core. This was added in conjunction with
...
here, originally written for Bitcoin but can also be used for The Holy Roger:
