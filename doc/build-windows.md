...
for Ubuntu Xenial does not produce working executables for some of the TheHolyRoger Core applications.
...
causes two of the theholyroger executables to crash shortly after start up. The bug is related to the
