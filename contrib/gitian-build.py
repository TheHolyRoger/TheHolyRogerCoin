...
def build():
    ...
    subprocess.check_call(['wget', '-O', 'inputs/osslsigncode-1.7.1.tar.gz', 'https://raw.githubusercontent.com/TheHolyRogerCoin/osslsigncode-1.7.1.tar.gz/master/osslsigncode-1.7.1.tar.gz'])
    subprocess.check_call(['wget', '-O', 'inputs/osslsigncode-Backports-to-1.7.1.patch', 'https://raw.githubusercontent.com/TheHolyRogerCoin/osslsigncode-1.7.1.tar.gz/master/osslsigncode-Backports-to-1.7.1.patch'])
